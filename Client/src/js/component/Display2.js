    ...
    <div className="row" >
         ...
         <div className="col-sm-9">
           <div className="list-group">
             ...
             <button type="submit" className="btn btn-warning" onClick={this.CreateAjax2}>delete</button>
                   ...
                   <div className="modal-body">
                      <form className="form-horizontal">
                       <div className="form-group">
                         <label className="col-lg-2 control-label" id="inputName"></label>
                       ...
                       <div className="form-group">
                         <div className="col-lg-12">
                           <button className="btn btn-success" type="submit" onClick={this.CreateAjax}>Update</button>
                         </div>
                       </div>
                     </form>
                   </div>
